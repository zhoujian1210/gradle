...
public class DefaultDependencySubstitutions implements DependencySubstitutionsInternal {
    ...
    private final ComponentSelectionDescription reason;
    ...
    private DefaultDependencySubstitutions(ComponentSelectionDescription reason, NotationParser<Object, ComponentSelector> projectSelectorNotationParser, ImmutableModuleIdentifierFactory moduleIdentifierFactory) {
    ...
    private DefaultDependencySubstitutions(ComponentSelectionDescription reason,
    ...
    public Substitution substitute(final ComponentSelector substituted) {
        return new Substitution() {
            ComponentSelectionDescriptionInternal substitutionReason = (ComponentSelectionDescriptionInternal) reason;
            @Override
    ...
    private static class ExactMatchDependencySubstitutionAction implements Action<DependencySubstitution> {
        private final ComponentSelectionDescriptionInternal selectionReason;
        private final ComponentSelector substituted;
        private final ComponentSelector substitute;

        public ExactMatchDependencySubstitutionAction(ComponentSelectionDescriptionInternal selectionReason, ComponentSelector substituted, ComponentSelector substitute) {
    ...
    private static class ModuleMatchDependencySubstitutionAction implements Action<DependencySubstitution> {
        ...
        public ModuleMatchDependencySubstitutionAction(ComponentSelectionDescriptionInternal selectionReason, ModuleIdentifier moduleId, ComponentSelector substitute) {
            this.selectionReason = selectionReason;
