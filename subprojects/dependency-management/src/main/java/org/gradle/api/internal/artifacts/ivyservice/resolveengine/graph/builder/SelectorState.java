...
class SelectorState implements DependencyGraphSelector {
    ...
    public ComponentSelectionReason getSelectionReason() {
        return selected == null ? VersionSelectionReasons.of(Collections.<ComponentSelectionDescription>singletonList(idResolveResult.getSelectionDescription())) : selected.getSelectionReason();
    }
